    ...
    <>
      <div
        ...
        className={cn(
          ...
          "before:from-neutral-950 before:bg-gradient-to-b before:to-transparent",
          "after:from-neutral-950 after:bg-gradient-to-t after:to-transparent",
          className,
        )}
      />
      <div
        ...
        className={cn(
          ...
          "before:from-neutral-950 before:bg-gradient-to-r before:to-transparent",
          "after:from-neutral-950 after:bg-gradient-to-l after:to-transparent",
          className,
        )}
      />
    </>
